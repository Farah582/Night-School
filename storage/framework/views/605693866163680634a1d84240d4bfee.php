...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <h3><a href="<?php echo e(url('/admin/login')); ?>">Admin</a></h3>
                <p>Head over to admin panel</p>
                <p>Manage users and courses</p>
            </div>
            <div class="col-sm-4">
                <h3><a href="<?php echo e(url('/teacher/login')); ?>">Teacher</a></h3>
                <p>Head over to teacher panel</p>
                <p>Manage schedules, attendances, assignments and remarks</p>
            </div>
            <div class="col-sm-4">
                <h3><a href="<?php echo e(url('/student/login')); ?>">Student</a></h3>
...
</html><?php /**PATH H:\BreakingGrad\Works\1_SchoolManagementLaravel\xampp\htdocs\NightSchool\resources\views/index.blade.php ENDPATH**/ ?>