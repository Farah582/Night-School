...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><?php echo e(__('Routine Schedule')); ?></div>

                    <div class="card-body">
                        <form method="POST" action="<?php echo e(url('classSchedule/store/'.$course->id)); ?>">
                            <?php echo csrf_field(); ?>

                            <div class="form-group row">
                                <label for="duration" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Duration (in days)')); ?></label>
...
</html><?php /**PATH H:\BreakingGrad\Works\1_SchoolManagementLaravel\xampp\htdocs\NightSchool\resources\views/teacher/home/routineSchedule.blade.php ENDPATH**/ ?>