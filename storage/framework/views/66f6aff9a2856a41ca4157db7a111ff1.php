                    ...
                    <div id="login-box" class="col-md-12">
                        ...
                        <form id="login-form" class="form" action="<?php echo e(url('teacher/registration')); ?>" method="post">
                            ...
                            <div id="register-link" class="text-right">
                                ...
                                <a href="<?php echo e(url('/')); ?>" class="text-info">Student panel</a>
                            </div>
                        </form>
                    </div>
                </div>
...
</html><?php /**PATH H:\BreakingGrad\Works\1_SchoolManagementLaravel\xampp\htdocs\NightSchool\resources\views/auth/registerTeacher.blade.php ENDPATH**/ ?>