        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(url('courses/store')); ?>">
                            <?php echo csrf_field(); ?>

                            <div class="form-group row">
                                <label for="number_of_courses" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Number of Courses')); ?></label>
...
</html><?php /**PATH H:\BreakingGrad\Works\1_SchoolManagementLaravel\xampp\htdocs\NightSchool\resources\views/admin/home/addCourse.blade.php ENDPATH**/ ?>