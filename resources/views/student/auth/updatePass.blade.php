...
<body>
    ...
    <div id="login">
        <h3 class="text-center text-info pt-5">Password reset - {{ $student->name }}</h3>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="{{ url('student/updatePass/' . $student->id . '/' . $resetCode) }}" method="post">
                            @csrf
